...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    className={cn(
      // pointer-events-none while closing: the overlay outlives the close by the
      // length of its fade-out, and without this it swallows the first tap that
      // lands during that window.
