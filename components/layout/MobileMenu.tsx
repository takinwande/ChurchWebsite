  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-72">
        ...
        {/* Links close the sheet via an explicit onClick rather than SheetClose.
            Wrapping a next/link in SheetClose races Radix's close-and-unmount
            against the client-side navigation, which drops taps intermittently
            on mobile. Closing from our own state keeps the two ordered. */}
